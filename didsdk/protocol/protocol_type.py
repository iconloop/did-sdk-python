...
class ProtocolType(Enum):
    ...
    def is_presentation(self) -> bool:
        return self in [self.RESPONSE_PRESENTATION,
                        self.RESPONSE_PRESENTATION_OLD, self.RESPONSE_PROTECTED_PRESENTATION]
    ...
    def is_credential_member(cls, value: str) -> bool:
        return value in [cls.RESPONSE_CREDENTIAL.value,
                         cls.RESPONSE_CREDENTIAL_OLD.value, cls.RESPONSE_PROTECTED_CREDENTIAL.value]

    @classmethod
    def is_presentation_member(cls, value: str) -> bool:
        return value in [cls.RESPONSE_PRESENTATION.value,
                         cls.RESPONSE_PRESENTATION_OLD.value, cls.RESPONSE_PROTECTED_PRESENTATION.value]

    @classmethod
    def is_request_member(cls, value: str) -> bool:
        return value in [cls.REQUEST_CREDENTIAL.value, cls.REQUEST_PRESENTATION.value,
                         cls.REQUEST_REVOCATION.value, cls.DID_INIT.value]

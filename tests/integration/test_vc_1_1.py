...
class TestVC_1_1:
    def test_did_full_sdk(self):
        ...
        protocol_message: ProtocolMessage = ProtocolMessage.for_request(protocol_type=ProtocolType.REQUEST_CREDENTIAL,
        ...
        base_claim: BaseClaim = BaseClaim(attribute_type=BaseClaim.HASH_TYPE,
                                          algorithm=HashedAttribute.DEFAULT_ALG,
                                          values=credential_request.claims)

        credential: Credential = Credential(algorithm=issuer_did_key_holder.type.name,
        ...
        protocol_message = ProtocolMessage.for_request(ProtocolType.REQUEST_PRESENTATION,
        ...
        base_vc: BaseVc = BaseVc(vc=decrypted_credential_pm.message,
                                 vc_type=vc_types,
                                 param=decrypted_credential_pm.base_param)
        ...
        protocol_message = ProtocolMessage.for_presentation(ProtocolType.RESPONSE_PROTECTED_PRESENTATION,

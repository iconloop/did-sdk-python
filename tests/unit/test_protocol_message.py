...
class TestProtocolMessage:
    ...
    def holder_did_key_holder_v_1_1(self, key_provider: KeyProvider, holder_did, holder_key_id) -> DidKeyHolder:
        ...
        return DidKeyHolder(did=holder_did,
    ...
    def holder_did_key_holder_v_2_0(self, holder_did, holder_key_id, algorithm) -> DidKeyHolder:
        ...
        return DidKeyHolder(key_id=key_provider.key_id,
                            type=key_provider.type,
                            private_key=key_provider.private_key,
                            did=owner_did)
    ...
    def revoke_claim_request_v_1_1(self, holder_did_key_holder_v_1_1, revocation_sig) -> ClaimRequest:
        ...
        return ClaimRequest.for_revocation(algorithm=holder_did_key_holder_v_1_1.type,
    ...
    def claim_request_v_2_0(self, holder_did_key_holder_v_2_0, request_credential_public_key) -> ClaimRequest:
        ...
        context: list = ["https://vc-test.zzeung.id/credentials/v1.json",
    ...
    def test_create_for_revocation_request_v_1_1(self, key_provider: KeyProvider,
                                                 holder_did: str,
    ...
    def test_create_for_credential_v_2_0(self, holder_did_key_holder_v_2_0: DidKeyHolder,
        ...
        # WHEN try to create a ProtocolMessage.
        protocol_message = ProtocolMessage.for_request(protocol_type=ProtocolType.REQUEST_CREDENTIAL,

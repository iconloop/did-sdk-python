...
class TestClaimRequest:
    @pytest.mark.parametrize('claim_types, claim_values', [
        (['email'], ['abc@iconloop.com']),
        (['email', 'phone', 'age'], ['abc@iconloop.com', '012-3456-7890', 18])
    ], ids=['single', 'multi'])
    ...
    def test_revocation_request(self):
        ...
        holder_did_key_holder = DidKeyHolder(did=holder_did,
        ...
        claim_request: ClaimRequest = ClaimRequest.for_revocation(algorithm=holder_did_key_holder.type,
